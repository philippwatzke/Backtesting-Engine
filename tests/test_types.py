...
class TestConstants:
    ...
    def test_signal_codes(self):
        ...
        assert SIGNAL_MOC_LONG == SIGNAL_LONG
        assert SIGNAL_MOC_SHORT == SIGNAL_SHORT
...
class TestParamsIndexConstants:
    def test_indices_are_sequential(self):
        indices = [
            ...
            PARAMS_SMA_PERIOD, PARAMS_BREAKEVEN_TRIGGER_TICKS,
    ...
    def test_profile_indices_are_sequential(self):
        indices = [
            PROFILE_RISK_PER_TRADE_USD,
            PROFILE_STOP_ATR_MULTIPLIER,
            PROFILE_TARGET_ATR_MULTIPLIER,
